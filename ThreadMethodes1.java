...
class MyThread2 extends Thread{
    ...
    public void run() {
        for(int i = 0; i <10; i++){
            ...
            Thread.yield();// it is giving the hint to the JVM that give each thread chance to execute.
        }
...
public class ThreadMethodes1 {
    public static void main(String[] args){
        ...
        // it is telling that whatever you are doing stop there , <like the thread is sleeping , waiting anything stop there>
