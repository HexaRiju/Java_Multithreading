...
class DepandentServer implements Callable<String>{

    private final CountDownLatch latch;

    DepandentServer(CountDownLatch latch) {
        this.latch = latch;
    }
    @Override
...
public class ExecuteExample {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        Future<String> future1 = executeFramework.submit(new DepandentServer(latch));
        Future<String> future2 = executeFramework.submit(new DepandentServer(latch));
        Future<String> future3 = executeFramework.submit(new DepandentServer(latch));
